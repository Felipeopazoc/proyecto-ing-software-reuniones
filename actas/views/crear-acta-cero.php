									...
									<div class="col-span-12 md:mt-4">
										...
										<div>
											<select name="id_estado" class="block w-full mt-1 form-select">
												...
												foreach ($conn->query($consulta_reuniones) as $reunion) {

													echo "<option value='" . $reunion['reu_cod'] . "'>" . $reunion['reu_titulo'] . "</option>";
										...
										<div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
											...
											<div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-3xl sm:w-full">
												...
												<div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
													<button class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-green-400 text-base font-medium text-white hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 sm:ml-3 sm:w-auto sm:text-sm" name="submit" type="submit" value="submit">Enviar</button>
