...
<body class="antialiased bg-gray-200 " style="background-color: #080F28;">
		...
		<div class="hidden lg:flex-1 lg:flex lg:items-center lg:w-auto w-full text-white" id="menu">
			<nav>
				<ul class="lg:flex items-center justify-between text-base pt-4 lg:pt-0">
					<li>
						<a class="lg:p-4 py-3 px-0 block border-b-2 border-transparent hover:border-indigo-400" href="#">Inicio</a>
					</li>
					<li>
						<a class="lg:p-4 py-3 px-0 block border-b-2 border-transparent hover:border-indigo-400" href="../../listado_reuniones/index.php">Reuniones</a>
					</li>
					<li>
						<a class="lg:p-4 py-3 px-0 block border-b-2 border-transparent hover:border-indigo-400" href="../../registrar_comentario/index.php">Comentar Reuniones</a>
					</li>
					<li>
						<a class="lg:p-4 py-3 px-0 block border-b-2 border-transparent hover:border-indigo-400" href="../../home_vecino/buscador_actas.php">Actas</a>
					</li>
				</ul>
			</nav>
		</div>
	...
	<main class="flex flex-col-reverse min-h-screen max-w-6xl mx-auto sm:flex-row">
		...
		<section class="px-6 sm:w-full ">
			...
			<div class="">
				<section id="formulario">
					<div>
						<form action="../backend/crear-acta.php" method="POST">
		...
		<section class="px-6 sm:w-full text-white">
			...
			foreach ($conn->query($sql) as $reuniones) {  ?>
				...
				<!-- component -->
				<div class="py-6">
					<div class="flex max-w-3xl overflow-hidden bg-white rounded-lg shadow-lg">
						<div class="w-1/3 bg-cover" style="background-image: url('https://images.unsplash.com/photo-1606857521015-7f9fcf423740?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=300&q=80')">
						</div>
						<div class="w-2/3 p-4">
